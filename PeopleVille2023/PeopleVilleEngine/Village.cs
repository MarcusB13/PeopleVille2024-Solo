...
public class Village
{
    ...
    public Village()
    {
        ...
        BaseLoader loader = new BaseLoader(this);
        loader.LoadAddons();
        _addons = loader.Addons;

        loader.SendSubscriptions();
    }
    ...
    private List<IVillagerCreator> LoadVillagerCreatorFactories()
    {
        ...
        var libraryFiles = Directory.EnumerateFiles(AppDomain.CurrentDomain.BaseDirectory + "lib").Where(f => Path.GetExtension(f) == ".dll");
